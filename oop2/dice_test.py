...
def main():
    ...
    score_list.append(sum(cheater1.get_dice()))
    score_list.append(sum(cheater2.get_dice()))
    score_list.append(sum(cheater3.get_dice()))

    print(score_list)
    
    print("Player",score_list.index(max(score_list)) + 1, "wins! ")
